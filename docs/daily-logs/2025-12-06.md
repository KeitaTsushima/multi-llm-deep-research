...
- 📝 Reviewed feedback from 3 external reviewers on config.py
- ✅ Added pytest to CI workflow
- 📚 Documented deferred items in PLAN-01 Future Improvements
- 🔍 Researched Deep Research APIs across providers
...
|----------|-----|--------------|
| OpenAI | o3/o4-mini-deep-research | ❌ (v1.x) |
| Perplexity | sonar-deep-research | ❌ (v1.x) |
| Anthropic | Web Search API + agent loop | ❌ (v1.x) |
| Gemini | Consumer only | ❌ |
